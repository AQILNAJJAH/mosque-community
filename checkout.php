...
if(isset($_POST['order_btn'])){
   ...
   if($cart_query && $detail_query){
      ...
      echo "
      <div class='order-message-container' id='order-message-container'>
      <div class='message-container'>
         <h3>thank you for shopping!</h3>
         <div class='order-detail'>
            <span>".$total_product."</span>
            <span class='total'> total : RM".number_format($price_total, 2)."/-  </span>
         </div>
...
<section class="checkout-form">
   ...
   <div class="display-order">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>city</span>
            <input type="text" placeholder="e.g. Gurun" name="city" required>
         </div>
         <div class="inputBox">
            <span>state</span>
...
<script>
   function closeMessage() {
      document.getElementById('order-message-container').style.display = 'none';
   }
</script>
