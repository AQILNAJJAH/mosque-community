...
function build_calendar($month, $year) {
    $mysqli = new mysqli('localhost', 'root', '', 'mosque', 3308);
    ...
    $calendar .= "<a class='btn btn-xs btn-success' href='?month=" . ($month - 1 == 0 ? 12 : $month - 1) . "&year=" . ($month - 1 == 0 ? $year - 1 : $year) . "'>Previous Month</a> ";
    $calendar .= " <a class='btn btn-xs btn-danger' href='?month=" . date('m') . "&year=" . date('Y') . "'>Current Month</a> ";
    $calendar .= "<a class='btn btn-xs btn-primary' href='?month=" . ($month + 1 == 13 ? 1 : $month + 1) . "&year=" . ($month + 1 == 13 ? $year + 1 : $year) . "'>Next Month</a></center><br>";
...
<body style="background:#eee">
    <div class="container alert alert-default" style="background:#fff">
        <div class="row">
            <div class="col-md-12">
                <div class="alert alert-danger" style="background:#466186;border:none;color:#fff">
                    <h1>Hall Booking</h1>
                </div>               
                <?php
                ...
                ?>
                <a href="hall.html" class="btn btn-warning">Back</a>
                <a href="admin/index.php" class="btn btn-warning">Admin</a>
            </div>
        </div>
    </div>
</body>
